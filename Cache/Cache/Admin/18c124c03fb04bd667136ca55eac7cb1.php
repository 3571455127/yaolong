...
<div class="content_2">
	<div class="tabbox" style="display:block;">
      ...
      <tr>
		...
		<td><input type="text" name="catname" class="input-text  required"  id="catname" value="<?php echo ($vo['catname']); ?>"  minlength="1"  maxlength="30"  /></td>
		</tr>

	    <tr>
		<td>* <?php echo L('catdir');?></td>
		<td><input type="text" id="catdir" name="catdir" class="input-text  required" value="<?php echo ($vo['catdir']); ?>" validate="required:true, english:true,minlength:1, maxlength:30"/><span class="catdirBtn" onclick="catdir.value=($('#catname').toPinyin());"><?php echo L('pinyin');?></span></td>
		</tr>
